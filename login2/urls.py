...
urlpatterns = [
    ...
    # path('Change_Password/'), views.change_password, name='passwordchangeview'),
    ...
    path('password_change/',
         auth_views.PasswordChangeView.as_view(template_name="login2/password_change_form.html", success_url='login2/password_change_done'),
         name = "password_change"),
    path('password_change/done/',
         auth_views.PasswordChangeDoneView.as_view(template_name="login2/password_change_done.html"),
