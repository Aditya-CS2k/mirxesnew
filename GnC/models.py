...
class departmental_competencies_comment(models.Model):
    departmental_competencies = models.ForeignKey('Departmental_Competencies', blank=False, null=False,
...
class KPI(models.Model):
    ...
    progress = models.CharField(max_length=50, blank=False, null=False, choices=PROGRESS_CHOICES, default='Working')
...
class Goals(models.Model):
    ...
    MID_user_comments = models.TextField(blank=False, null=False, default='NIL')
    MID_manager_comments = models.TextField(blank=False, null=False, default='NIL')
    ...
    user_comments = models.TextField(blank=False, null=False, default='NIL')
    manager_comments = models.TextField(blank=False, null=False, default='NIL')
    board_comments = models.TextField(blank=False, null=False, default='NIL')
    tracking_status = models.TextField(blank=False, null=True, default='null', choices=TRACKING_CHOICES)
