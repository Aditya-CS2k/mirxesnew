...
class peerAppraisal(models.Model):
    ...
    title1 = models.CharField(max_length=500, blank = False, null = False)
    ...
    title2 = models.CharField(max_length=500, blank = False, null = False, default = 'NIL')
    ...
    title3 = models.CharField(max_length=500, blank = False, null = False, default = 'NIL')
