...
class CreateOverallAppraisalForm_Stage1(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "name": "Name of Performance Appraisal",
...
class CreateOverallAppraisalForm_Stage4(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "goal_weightage": "Business Objectives Weightage (%)",
            "competency_weightage": "MiRXES Behaviours Blueprint Weightage (%)",
            "skill_weightage": "Skill Weightage (%)-(Not Applicable)"
        }

        widgets = {
            'goal_weightage': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter weightage of Business Objectives',
                'style': 'width: 70%'
            }),
            'competency_weightage': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter weightage of MiRXES Behaviours Blueprint',
                'style': 'width: 70%'
            }),
...
class CreateOverallAppraisalForm_Ref(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'goal_weightage': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter the weightage of Business Objectives'
            }),
            'competency_weightage': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter the weightage of MiRXES Behaviours Blueprint'
            }),
            'skill_weightage': forms.NumberInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter the weightage of Skills'
...
class CreateCareerDiscussionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            "Q1": "Summarise the employee's achievement against Objectives",
            "Q2": "Summary on Strengths",
            "Q3": "Developmental Plan/ Needs(Actions and Timing)",
            "Q4": "Potential next moves",
            "Q5": "Longer Term: 0-5 years",
        }
        widgets = {
            'Q1': forms.Textarea(
...
class CreateCareerDiscussionForm2(forms.ModelForm):
    class Meta:
        ...
        labels = {
            "Q1": "Summarize the employee's achievement against objectives",
            "Q2": "Summary on Strengths",
            "Q3": "Development Plan/Needs (Action and Timing)",
            "Q4": "Potential next moves",
            "Q5": "Longer Term: 3-5 years",
        }
        widgets = {
            'Q1': forms.Textarea(
                attrs={'class': 'form-control col-8',
...
class AppGoalsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['description'].widget.attrs['readonly'] = True
        self.fields['MID_user_comments'].widget.attrs['readonly'] = True
        self.fields['MID_manager_comments'].widget.attrs['readonly'] = True
...
class AppSkillsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
                "description": "Please provide reason and where appropriate,specify any area of improvement required and how these will be monitored ",
            'skill_category': "Option",
            "user_comments": "Length of the PIP(max 3-6 months)",
            "recommended_Trainings_user": "Date"
           # "description": "Skill",
