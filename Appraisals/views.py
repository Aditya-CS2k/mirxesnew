...
# from .forms import AppGoalsForm, AppCompetenciesForm, peerAppraisalForm, MAppCompetenciesForm, MAppGoalsForm, \
#     BAppGoalsForm, BAppCompetenciesForm, CreateAppraisalCategoryForm, CreateRatingScaleForm, UpdateOverallAppraisalForm, \
...
#     totalsum += sum * overallappraisal.goal_weightage / (
#                 overallappraisal.goal_weightage + overallappraisal.competency_weightage + overallappraisal.skill_weightage)
#
#     sum = 0
#     weightage_count = 0
...
#     totalsum += sum * overallappraisal.competency_weightage / (
#                 overallappraisal.goal_weightage + overallappraisal.competency_weightage + overallappraisal.skill_weightage)
#
#     sum = 0
#     weightage_count = 0
...
#     totalsum += sum * overallappraisal.skill_weightage / (
#                 overallappraisal.goal_weightage + overallappraisal.competency_weightage + overallappraisal.skill_weightage)
#
...
#                              'End-Year Rating End Date can not start later than its Moderation-by-Management End Date')
#             return HttpResponseRedirect(reverse('Appraisals:Create_Overall_Appraisal_Stage3', args=(overall_app.id,)))
#
#         elif (overall_app.reports_end_date > overall_app.calibration_end_date):
#             messages.warning(request,
#                              'End-Year Moderation-by-Management End Date can not start later than its Calibration End Date')
#             return HttpResponseRedirect(reverse('Appraisals:Create_Overall_Appraisal_Stage3', args=(overall_app.id,)))
#
#         form.save()
#
...
#                 reverse('Appraisals:Create_Overall_Appraisal_Stage4', args=(overall_appraisal.id,)))
#         overall_app.rating_scale = 'Denselight System'
#         overall_app.status = 'Stage 1'
#         overall_app.save()
#         if len(list_of_emails) > 0:
#             send_mail('The Performance Appraisal Exercise has started!', email_string,
#                       from_email='denselight_epmp@consulthunet.com', recipient_list=list_of_emails, fail_silently=True)
#         return HttpResponseRedirect(reverse('user_homepage'))
#
#     context = {
#         'form': form
...
#                 send_mail('Initialisation of Performance Appraisal Launch', email_string,
#                           from_email='denselight_epmp@consulthunet.com', recipient_list=listOfEmails,
#                           fail_silently=True)
#             except Exception:
#                 pass
#
...
#                 send_mail('Mid-Year Review has started!', email_string, from_email='denselight_epmp@consulthunet.com',
...
#                 send_mail('Year-End Review has started!', email_string, from_email='denselight_epmp@consulthunet.com',
#                           recipient_list=listOfEmails, fail_silently=True)
#             except Exception:
#                 pass
#         return HttpResponseRedirect(reverse('user_homepage'))
...
#     writer.writerow(
#         ['Name', 'Department', 'Email', 'Job Title', "Manager's Name", 'Goals Count', 'Core Values Competencies Count',
#          'Skills Count', "Employee's Rating", "Manager's Rating", "Board's Rating", 'Rewards Recommendations',
#          'Training & Development Recommendations(Employee)', 'Training & Development Recommendations(Manager)',
#          'Training & Development Recommendations(Board)', "Employee's Comments (Goals)",
#          "Employee's Comments (Competencies)", "Employee's Comments (Skills)", "Manager's Comments (Goals)",
#          "Manager's Comments (Competencies)", "Manager's Comments (Skills)", "Board's Comments (Goals)",
#          "Board's Comments (Competencies)", "Board's Comments (Skills)", ])
#
#     name = ""
#     department = ""
#     email = ""
...
#     all_board_TDR = ""
#
#     rewards_recommendation_manager = 'Increment: ' + str(user_appraisal.incrementRecommendation) + '% | Bonus: ' + str(
...
#     comment_counter = 0
#
#     writer.writerow([name, department, email, job_title, manager_name, goals_count, competencies_count, skills_count,
#                      employee_rating, manager_rating, board_rating, rewards_recommendation_manager, all_employees_TDR,
#                      all_managers_TDR, all_board_TDR, goals_employees_comments, goals_manager_comments,
#                      goals_board_comments, competencies_employees_comments, competencies_manager_comments,
#                      competencies_board_comments, skills_employees_comments, skills_manager_comments,
#                      skills_board_comments, ])
#
...
#     writer = csv.writer(response)
#     writer.writerow(
#         ['Name', 'Department', 'Job Title', "Manager's Name", 'Goals Count', 'Core Values Competencies Count',
#          'Skills Count', "Employee's Rating", "Manager's Rating", "Board's Rating", 'Rewards Recommendations',
#          'Training & Development Recommendations(Employee)', 'Training & Development Recommendations(Manager)',
#          'Training & Development Recommendations(Board)', "Employee's Comments (Goals)",
#          "Employee's Comments (Competencies)", "Employee's Comments (Skills)", "Manager's Comments (Goals)",
...
#         all_board_TDR = ""
#
#         rewards_recommendation_manager = 'Increment: ' + str(
#             user_appraisal.incrementRecommendation) + '% | Bonus: ' + str(user_appraisal.bonusRecommendation)
#
#         goals_count = user_appraisal.goals_set.count()
#         competencies_count = user_appraisal.competencies_set.count()
#         skills_count = user_appraisal.skills_set.count()
...
#
#         writer.writerow(
#             [name, department, job_title, manager_name, goals_count, competencies_count, skills_count, employee_rating,
#              manager_rating, board_rating, rewards_recommendation_manager, all_employees_TDR, all_managers_TDR,
#              all_board_TDR, goals_employees_comments, goals_manager_comments, goals_board_comments,
#              competencies_employees_comments, competencies_manager_comments, competencies_board_comments,
#              skills_employees_comments, skills_manager_comments, skills_board_comments, ])
#
...
#         writer.writerow(
#             [name, department, job_title, manager_name, goals_count, competencies_count, skills_count, employee_rating,
#              manager_rating, board_rating, rewards_recommendation_manager, ])
#
...
#     writer.writerow(
#         ['Name', 'Department', 'Job Title', "Manager's Name", 'Goals Count', 'Core Values Competencies Count',
#          'Skills Count', "Employee's Rating", "Manager's Rating", "Board's Rating",
#          'Training & Development Recommendations(Employee)', 'Training & Development Recommendations(Manager)',
#          'Training & Development Recommendations(Board)', "Employee's Comments (Goals)",
#          "Employee's Comments (Competencies)", "Employee's Comments (Skills)", "Manager's Comments (Goals)",
#          "Manager's Comments (Competencies)", "Manager's Comments (Skills)", "Board's Comments (Goals)",
...
#         writer.writerow(
#             [name, department, job_title, manager_name, goals_count, competencies_count, skills_count, employee_rating,
#              manager_rating, board_rating, all_employees_TDR, all_managers_TDR, all_board_TDR, goals_employees_comments,
#              goals_manager_comments, goals_board_comments, competencies_employees_comments,
...
def APPRAISAL_LAUNCHING_EMAIL(overall_appraisal):
    email_string = "Dear user, \n\nThe Performance Appraisal Exercise has started! \n\nPlease see the deadlines for the various stages below \n\t 1.Goals Setting Exercise: " + str(
        ...
        overall_appraisal.appraisal_end_date) + "\n\t 4.Reports: " + str(
        overall_appraisal.reports_end_date) + "\n\t 5.Calibration: " + str(
                overall_appraisal.calibration_end_date) + "\n\nWhat's next? \nLogin to your account to add your Goals, Core Values Competencies and Skills.Click Here http://134.122.84.112/login \n\nPlease do not hesitate to contact the HR Department if you have any questions. \nThank you."
    return email_string


def MID_YEAR_REVIEW_EMAIL(dateline):
    email_string = "Dear user, \n\nThe Mid-Year Review has started!\nPlease remember to complete your Mid-Year review form by " + dateline + "\n\nClick Here:http://134.122.84.112/login\n\n 1.Goals Setting Exercise: " + str(
        overall_appraisal.goals_setting_end_date) + "\n\t 2.Mid-Year Review:" + str(
        overall_appraisal.mid_year_end_date) + "\n\t 3.Year-End Review: " + str(
        overall_appraisal.appraisal_end_date) + "\n\t 4.Reports: " + str(
        overall_appraisal.reports_end_date) + "\n\t 5.Calibration: " + str(
...
def UpdateAppraisalCareer_B(request, *args, **kwargs):
    ...
    if request.method == 'POST':
        #return HttpResponseRedirect(reverse('Appraisals:Update_Appraisal_B', args=(id,)))
        return HttpResponseRedirect(reverse('Appraisals:Update_AppraisalS_B', args=(id,)))
    context = {
        'grade': final_grade,
        'user_app': user_appraisal_list,
        'user_career_discussion': car_discussion
